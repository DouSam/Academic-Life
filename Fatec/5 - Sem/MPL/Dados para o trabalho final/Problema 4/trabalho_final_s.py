...
with open('inst_20_15.txt') as arquivo:
...
#sensitivity() # Printar o problema de maneira mais clara
...
# isso estava complicando no momento de extrair as informações. Recomendo a execução
# pelo colab, dependendo do SO a tabela não é 'printada' corretamente.
