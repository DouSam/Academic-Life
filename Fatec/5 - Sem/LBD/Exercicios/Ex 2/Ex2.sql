...
FROM tb_pais;
	...
	-- Inserção de dados 'tb_localizacao'
...
FROM tb_localizacao;
	...
	-- Inserção de dados 'tb_departamento'
...
INSERT INTO tb_funcao
VALUES ('PR_REP', 'Representante de Relações Publica', 4500, 10500);

SELECT *
FROM tb_funcao;

	-- Inserção de dados 'tb_empregado'
...
-- Inserção de dados 'tb_historico_funcao'
...
SELECT COUNT(*) qtd_regiao
FROM tb_regiao;

SELECT COUNT(*) qtd_pais
FROM tb_pais;

SELECT COUNT(*) qtd_loc
FROM tb_localizacao;

SELECT COUNT(*) qtd_depto
FROM tb_departamento;

SELECT COUNT(*) qtd_func
FROM tb_funcao;

SELECT COUNT(*) qtd_emp
FROM tb_empregado;

SELECT COUNT(*) qtd_hist
FROM tb_historico_funcao;
